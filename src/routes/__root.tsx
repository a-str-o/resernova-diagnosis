...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ReserNova Business Health Check diagnostic app." },
      { property: "og:title", content: "ReserNova Diagnosis" },
      { property: "og:description", content: "ReserNova Business Health Check diagnostic app." },
