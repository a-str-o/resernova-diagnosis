...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-k6r1G6x1.js
var server_k6r1G6x1_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ClmlGUpl.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-7SAz_osL.mjs").then((n) => n.t),
		import("./start-DgMrYic2.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_k6r1G6x1_exports as t };
