...
//#region node_modules/.nitro/vite/services/ssr/assets/router-7SAz_osL.js
...
var styles_default = "/assets/styles-DS5SGVlw.css";
var LANGS = [
	{
		code: "en",
		label: "English",
...
var translations = {
	...
	"results.overall": {
		en: "Overall business score",
		fr: "Score global",
		ar: "النقطة العامة"
	},
	"results.category.operations": {
		en: "Operations",
		fr: "Opérations",
		ar: "التنظيم"
	},
	"results.category.bookings": {
		en: "Bookings",
		fr: "Réservations",
		ar: "المواعد"
	},
	...
	"dash.title": {
		en: "Sales dashboard",
		fr: "Tableau de bord commercial",
		ar: "لوحة المبيعات"
	},
	"dash.totalLeads": {
		en: "Total leads",
		fr: "Total prospects",
		ar: "مجموع الزبناء المحتملين"
	},
	"dash.hotLeads": {
		en: "Hot leads",
		fr: "Prospects chauds",
	...
	"dash.backToLeads": {
		en: "Back to leads",
		fr: "Retour aux prospects",
		ar: "رجوع للائحة"
	},
	"dash.leadScore": {
		en: "Lead score",
		fr: "Score du prospect",
		ar: "نقطة الزبون المحتمل"
	},
	"dash.mainPains": {
		en: "Main pain points",
	...
	"lead.priority.qualified": {
		en: "Qualified",
		fr: "Qualifié",
		ar: "مؤهل"
	},
	"lead.priority.nurture": {
		en: "Nurture",
		fr: "À nourrir",
		ar: "متابعة"
	},
	...
	"score.booking_volume": {
		en: "Booking volume",
		fr: "Volume de réservations",
		ar: "عدد المواعد"
	},
	...
	"score.crm_maturity": {
		en: "CRM maturity",
		fr: "Maturité CRM",
		ar: "نضج تدبير الزبناء"
	},
	"score.growth": {
		en: "Growth potential",
		fr: "Potentiel de croissance",
		ar: "إمكانية التطور"
	},
	"score.urgency": {
		en: "Buying urgency",
...
var STORAGE_KEY = "resernova.lang";
...
var Route$4 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{ title: "ReserNova Diagnosis" },
			{
				name: "description",
				content: "ReserNova Business Health Check diagnostic app."
			},
			{
				property: "og:title",
				content: "ReserNova Diagnosis"
			},
			{
...
*/
var ALLOWED_EMAIL = "younes@gmail.com";
/**
...
async function signInWithPassword(email, password) {
	...
	if (normalized !== "younes@gmail.com".toLowerCase()) return {
		ok: false,
...
function isAllowedEmail(email) {
	return !!email && email.toLowerCase() === "younes@gmail.com".toLowerCase();
}
var $$splitComponentImporter$3 = () => import("./routes-DYwW7Z9I.mjs");
var Route$3 = createFileRoute("/")({
	...
	head: () => ({ meta: [
		...
		{
			name: "description",
			content: "A 5-minute business health check for Moroccan salons, barbers and spas: find missed WhatsApp bookings, no-show impact and the right ReserNova plan."
		},
		{
			property: "og:title",
			content: "ReserNova Business Diagnostic for Salons & Spas"
		},
		{
			property: "og:description",
...
var $$splitComponentImporter$2 = () => import("./login-CTE4r49h.mjs");
var Route$2 = createFileRoute("/login")({
	ssr: false,
	head: () => ({ meta: [{ title: "Sign in | ReserNova" }, {
		name: "robots",
		content: "noindex"
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./admin.clients-DyDrGrRt.mjs");
var Route$1 = createFileRoute("/admin/clients")({
	ssr: false,
	head: () => ({ meta: [{ title: "Clients | ReserNova" }, {
		name: "robots",
		content: "noindex"
	}] }),
	beforeLoad: async () => {
...
var $$splitNotFoundComponentImporter = () => import("./diagnostic._id-CRYb7CVi.mjs");
var $$splitErrorComponentImporter = () => import("./diagnostic._id-C41350Cw.mjs");
var $$splitComponentImporter = () => import("./diagnostic._id-BFRVpyYN.mjs");
var Route = createFileRoute("/diagnostic/$id")({
	ssr: false,
	head: () => ({ meta: [
		{ title: "Business Diagnostic Report | ReserNova" },
		{
			name: "description",
			content: "Personalized business health check for beauty businesses: missed bookings, no-show impact and recommended ReserNova plan."
		},
		{
			property: "og:title",
			content: "Business Diagnostic Report | ReserNova"
		},
		{
			property: "og:description",
...
var rootRouteChildren = {
	...
	AdminClientsRoute: Route$1.update({
		id: "/admin/clients",
		path: "/admin/clients",
		getParentRoute: () => Route$4
	}),
	DiagnosticIdRoute: Route.update({
		id: "/diagnostic/$id",
		path: "/diagnostic/$id",
		getParentRoute: () => Route$4
	})
...
//#endregion
export { signInWithPassword as a, LANGS as c, getSession as i, Route as n, signOut as o, ALLOWED_EMAIL as r, useLanguage as s, router_exports as t };
